...
export default function ThreeText() {
  ...
  useEffect(() => {
    ...
    // Rim/back light
    const rimLight = new THREE.DirectionalLight(0x88ccff, 0.7); // bluish tint
    ...
    for(let i = 0; i < particlesCount; i++) {
      positionBuffer[i * 3] = (Math.random() - 0.5) * 100; // X
      positionBuffer[i * 3 + 1] = (Math.random() - 0.5) * 100; // Y
      positionBuffer[i * 3 + 2] = (Math.random() * -100) + 50; // Z
